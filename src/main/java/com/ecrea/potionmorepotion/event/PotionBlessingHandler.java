...
import com.ecrea.potionmorepotion.network.PotionBreathPacket;
...
/**
 * Client-side handler for the Potion Blessing splash potion thrower.
 * Detects right-click (keyUse) hold every tick and sends a PotionBreathPacket to the server.
 */
@Mod.EventBusSubscriber(modid = PotionMorePotionMod.MOD_ID, value = Dist.CLIENT)
public class PotionBlessingHandler {
    ...
    public static void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        var effectObj = ModMobEffects.EFFECTS.get("potion_blessing");
        ...
        ModMessages.sendToServer(new PotionBreathPacket());
        ...
        for (int i = 0; i < 2; i++) {
            ...
            player.level().addParticle(isSneaking ? ParticleTypes.HEART : ParticleTypes.EFFECT,
